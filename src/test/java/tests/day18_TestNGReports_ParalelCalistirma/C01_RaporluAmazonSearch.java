...
public class C01_RaporluAmazonSearch extends TestBaseRapor {
    ...
    public void test01() {
        ...
        extentTest.pass("Belirlenen " +ConfigReader.getProperty("amazonAranacakKelime") +" aranacak kelime aratildiginda, arama sonucunda expected icerik oldugu test edildi");
