...
public class C01_ReusableMethodsSwitchingWindow {
    ...
    public void test01() throws InterruptedException {
        ...
        softAssert.assertEquals(actualYazi,expectedYazi,"ilk sayfa text testi Opening a new window degil");
        ...
        softAssert.assertEquals(actualTitle, expectedTitle,"2.sayfa title The Internet degil");
        ...
        softAssert.assertEquals(actualYazi, expectedYazi);
